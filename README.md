...
- Dan tulis bahasa pemrograman perintah output ini :
     ...
     print("Hello World!")
   ```
<img src="https://github.com/imammularif/Basic---Python/blob/main/image/2.png?raw=true" width="50%">
...
Sampai segini dulu untuk pengenalan bahasa pemrograman python, dimana author sendiri untuk mempelajarinya sampai pusing 7 keliling, karena ada structur ataupun fungsi yang lain lebih comlexseperti pengolahaan dat big data dll nya di banding fungsi hello word ini,,hehe,,,see ya
